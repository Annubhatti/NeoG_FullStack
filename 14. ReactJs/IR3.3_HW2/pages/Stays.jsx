              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Wake up to a breathtaking view of the Taj Mahal fromthis
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    tranquility and stunning views while being surrounding by
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Experience urban living at its finest with this modren loft.
                    Conveniently located in the city center, it offers style,
                    comfoort, and easy access to dining and entairnment options.
                  </p>
                  <p className="card-text">
                    <small className="text-body-secondary">
